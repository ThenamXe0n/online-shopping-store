...
export default function CartPage() {
  ...
  const removeItem = (id) => {
    Confirm.show(
      ...
      async () => {
        try {
          const response = await dispatch(removeCartItemAsync(id)).unwrap();
          console.log("message remove cart", response);
    ...
    <div className="min-h-screen bg-gray-50 text-gray-900 px-4 sm:px-6 py-10">
      <div className="max-w-7xl mx-auto">
        ...
        {cartItems.length ? (
            ...
            <div>
              <div className="bg-white rounded-3xl shadow-xl border border-gray-100 p-6 sticky top-24">
                ...
                <button
                  ...
                  className="disabled:bg-neutral-400 w-full bg-black text-white py-4 rounded-full font-semibold text-sm shadow-lg hover:opacity-90 transition flex items-center justify-center gap-2"
                >
          ...
          <div className="h-[60vh] gap-4  flex flex-col items-center justify-center">
